# AppLovin plugin for godot engine. 

Register an account at https://www.applovin.com
...
Wrapper on gd-script will be in your autoloading list. Use global name `applovin` anywhere in your code to use API.
